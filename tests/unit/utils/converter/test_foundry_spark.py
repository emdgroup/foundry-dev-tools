...
def test_valid_schema_spark_to_foundry_decimal():
    foundry_schema = spark_schema_to_foundry_schema(StructType([StructField("price", DecimalType(17, 2), True, {})]))
...
def test_array_type_foundry_to_spark():
    ...
    assert spark_schema == StructType([StructField("purple_alias", ArrayType(StringType()), True, {})])
